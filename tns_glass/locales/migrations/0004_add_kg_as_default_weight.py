...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        kilogram = orm['locales.Weight'].objects.create(name="Kilograms", abbreviation="Kg", ratio_to_kilogram="1",
                                                        created_by_id=admin.id, modified_by_id=admin.id)

        for country in orm['locales.Country'].objects.all():
            country.weight = kilogram
            country.save()
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 8, 16, 4, 604086)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 8, 16, 4, 603337)'}),
