...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Country.weight'
        db.alter_column(u'locales_country', 'weight_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['locales.Weight']))


    def backwards(self, orm):
        
        # Changing field 'Country.weight'
        db.alter_column(u'locales_country', 'weight_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['locales.Weight']))
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 8, 44, 4, 706192)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 8, 44, 4, 704711)'}),
