...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Weight'
        db.create_table(u'locales_weight', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'locales_weight_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'locales_weight_modifications', to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64)),
            ('abbreviation', self.gf('django.db.models.fields.CharField')(unique=True, max_length=4)),
            ('ratio_to_kilogram', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=6)),
        ))
        db.send_create_signal(u'locales', ['Weight'])


    def backwards(self, orm):
        
        # Deleting model 'Weight'
        db.delete_table(u'locales_weight')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 8, 0, 50, 8636)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 8, 0, 50, 8039)'}),
