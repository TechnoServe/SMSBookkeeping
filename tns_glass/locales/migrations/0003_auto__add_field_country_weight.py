...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Country.weight'
        db.add_column(u'locales_country', 'weight', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='countries', null=True, to=orm['locales.Weight']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Country.weight'
        db.delete_column(u'locales_country', 'weight_id')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 8, 15, 8, 92570)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 8, 15, 8, 91940)'}),
        ...
        u'locales.country': {
            ...
            'weight': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'countries'", 'null': 'True', 'to': u"orm['locales.Weight']"})
        },
        u'locales.currency': {
