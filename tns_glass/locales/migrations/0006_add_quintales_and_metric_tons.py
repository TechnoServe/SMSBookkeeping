...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        quintal = orm['locales.Weight'].objects.create(name="Quintal", abbreviation="CWT", ratio_to_kilogram="45.359237",
                                                        created_by_id=admin.id, modified_by_id=admin.id)

        metric_tons = orm['locales.Weight'].objects.create(name="Metric Tons", abbreviation="mT", ratio_to_kilogram="1000",
                                                           created_by_id=admin.id, modified_by_id=admin.id)


        orm['locales.Country'].objects.filter(country_code__iexact="GT").update(weight=quintal)
