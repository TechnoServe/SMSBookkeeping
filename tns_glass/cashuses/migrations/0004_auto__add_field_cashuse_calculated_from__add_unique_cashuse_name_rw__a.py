...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CashUse.calculated_from'
        db.add_column('cashuses_cashuse', 'calculated_from', self.gf('django.db.models.fields.CharField')(default='NONE', max_length=4), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'CashUse.calculated_from'
        db.delete_column('cashuses_cashuse', 'calculated_from')
