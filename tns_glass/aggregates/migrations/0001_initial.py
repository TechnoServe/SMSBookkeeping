...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FinalizeTask'
        db.create_table('aggregates_finalizetask', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='finalizetask_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='finalizetask_modifications', to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seasons.Season'])),
            ('task_log', self.gf('django.db.models.fields.TextField')()),
            ('task_id', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
        ))
        db.send_create_signal('aggregates', ['FinalizeTask'])

        # Adding model 'SeasonAggregate'
        db.create_table('aggregates_seasonaggregate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seasons.Season'])),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, db_index=True)),
            ('average', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=4)),
            ('lowest', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=4)),
            ('highest', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=4)),
            ('best', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=4)),
        ))
        db.send_create_signal('aggregates', ['SeasonAggregate'])

        # Adding unique constraint on 'SeasonAggregate', fields ['season', 'slug']
        db.create_unique('aggregates_seasonaggregate', ['season_id', 'slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SeasonAggregate', fields ['season', 'slug']
        db.delete_unique('aggregates_seasonaggregate', ['season_id', 'slug'])

        # Deleting model 'FinalizeTask'
        db.delete_table('aggregates_finalizetask')

        # Deleting model 'SeasonAggregate'
        db.delete_table('aggregates_seasonaggregate')


    models = {
        'aggregates.finalizetask': {
            'Meta': {'ordering': "('-modified_on',)", 'object_name': 'FinalizeTask'},
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'finalizetask_creations'", 'to': "orm['auth.User']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'finalizetask_modifications'", 'to': "orm['auth.User']"}),
            ...
            'task_log': ('django.db.models.fields.TextField', [], {})
        },
        'aggregates.seasonaggregate': {
            'Meta': {'unique_together': "(('season', 'slug'),)", 'object_name': 'SeasonAggregate'},
            'average': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '4'}),
            'best': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '4'}),
            'highest': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '4'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lowest': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '16', 'decimal_places': '4'}),
            'season': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['seasons.Season']"}),
