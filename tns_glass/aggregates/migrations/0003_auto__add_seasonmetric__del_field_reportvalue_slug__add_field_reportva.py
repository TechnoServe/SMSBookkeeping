...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SeasonMetric'
        db.create_table('aggregates_seasonmetric', (
            ...
            ('is_cost', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('aggregates', ['SeasonMetric'])

        # Deleting field 'ReportValue.slug'
        db.delete_column('aggregates_reportvalue', 'slug')

        # Adding field 'ReportValue.metric'
        db.add_column('aggregates_reportvalue', 'metric', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['aggregates.SeasonMetric']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'SeasonMetric'
        db.delete_table('aggregates_seasonmetric')

        # User chose to not deal with backwards NULL issues for 'ReportValue.slug'
        raise RuntimeError("Cannot reverse this migration. 'ReportValue.slug' and its values cannot be restored.")

        # Deleting field 'ReportValue.metric'
        db.delete_column('aggregates_reportvalue', 'metric_id')
    ...
    models = {
        ...
        'aggregates.reportvalue': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metric': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['aggregates.SeasonMetric']"}),
        ...
        'aggregates.seasonmetric': {
            'Meta': {'object_name': 'SeasonMetric'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_cost': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 16, 11, 17, 42, 20371)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 16, 11, 17, 42, 20262)'}),
