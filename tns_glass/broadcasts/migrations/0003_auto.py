...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field exclude_wetmills on 'Broadcast'
        db.create_table('broadcasts_broadcast_exclude_wetmills', (
        ...
        db.create_unique('broadcasts_broadcast_exclude_wetmills', ['broadcast_id', 'wetmill_id'])

        # Adding M2M table for field exclude_csps on 'Broadcast'
        db.create_table('broadcasts_broadcast_exclude_csps', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('broadcast', models.ForeignKey(orm['broadcasts.broadcast'], null=False)),
            ('csp', models.ForeignKey(orm['csps.csp'], null=False))
        ))
        db.create_unique('broadcasts_broadcast_exclude_csps', ['broadcast_id', 'csp_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field exclude_wetmills on 'Broadcast'
        db.delete_table('broadcasts_broadcast_exclude_wetmills')

        # Removing M2M table for field exclude_csps on 'Broadcast'
        db.delete_table('broadcasts_broadcast_exclude_csps')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 5, 11, 8, 41, 895796)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 5, 11, 8, 41, 895713)'}),
        ...
        'broadcasts.broadcast': {
            ...
            'exclude_csps': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'excluded_broadcasts'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['csps.CSP']"}),
            'exclude_wetmills': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'excluded_broadcasts'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['wetmills.Wetmill']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
