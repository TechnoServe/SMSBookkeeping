...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Broadcast.with_sms'
        db.delete_column('broadcasts_broadcast', 'with_sms')

        # Deleting field 'Broadcast.season'
        db.delete_column('broadcasts_broadcast', 'season_id')

        # Deleting field 'Broadcast.with_reports'
        db.delete_column('broadcasts_broadcast', 'with_reports')

        # Adding field 'Broadcast.country'
        db.add_column('broadcasts_broadcast', 'country', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['locales.Country']), keep_default=False)

        # Adding field 'Broadcast.report_season'
        db.add_column('broadcasts_broadcast', 'report_season', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='report_broadcasts', null=True, to=orm['seasons.Season']), keep_default=False)

        # Adding field 'Broadcast.sms_season'
        db.add_column('broadcasts_broadcast', 'sms_season', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sms_broadcasts', null=True, to=orm['seasons.Season']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Broadcast.with_sms'
        db.add_column('broadcasts_broadcast', 'with_sms', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'Broadcast.season'
        raise RuntimeError("Cannot reverse this migration. 'Broadcast.season' and its values cannot be restored.")

        # Adding field 'Broadcast.with_reports'
        db.add_column('broadcasts_broadcast', 'with_reports', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Broadcast.country'
        db.delete_column('broadcasts_broadcast', 'country_id')

        # Deleting field 'Broadcast.report_season'
        db.delete_column('broadcasts_broadcast', 'report_season_id')

        # Deleting field 'Broadcast.sms_season'
        db.delete_column('broadcasts_broadcast', 'sms_season_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 24, 15, 37, 14, 421685)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 24, 15, 37, 14, 421594)'}),
        ...
        'broadcasts.broadcast': {
            ...
            'csps': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['csps.CSP']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'messages': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['rapidsms_httprouter.Message']", 'null': 'True', 'blank': 'True'}),
            ...
            'report_season': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'report_broadcasts'", 'null': 'True', 'to': "orm['seasons.Season']"}),
            'send_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'sent': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sms_season': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sms_broadcasts'", 'null': 'True', 'to': "orm['seasons.Season']"}),
