...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('broadcasts_broadcast', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='broadcast_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='broadcast_modifications', to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('recipients', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seasons.Season'])),
            ('with_reports', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('with_sms', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('text', self.gf('django.db.models.fields.TextField')(max_length=480)),
        ...
        db.create_table('broadcasts_broadcast_wetmills', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('broadcast', models.ForeignKey(orm['broadcasts.broadcast'], null=False)),
            ('wetmill', models.ForeignKey(orm['wetmills.wetmill'], null=False))
        ))
        db.create_unique('broadcasts_broadcast_wetmills', ['broadcast_id', 'wetmill_id'])

        # Adding M2M table for field csps on 'Broadcast'
        db.create_table('broadcasts_broadcast_csps', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('broadcast', models.ForeignKey(orm['broadcasts.broadcast'], null=False)),
            ('csp', models.ForeignKey(orm['csps.csp'], null=False))
        ))
        db.create_unique('broadcasts_broadcast_csps', ['broadcast_id', 'csp_id'])

        # Adding M2M table for field messages on 'Broadcast'
        db.create_table('broadcasts_broadcast_messages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('broadcast', models.ForeignKey(orm['broadcasts.broadcast'], null=False)),
            ('message', models.ForeignKey(orm['rapidsms_httprouter.message'], null=False))
        ))
        db.create_unique('broadcasts_broadcast_messages', ['broadcast_id', 'message_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('broadcasts_broadcast_wetmills')

        # Removing M2M table for field csps on 'Broadcast'
        db.delete_table('broadcasts_broadcast_csps')

        # Removing M2M table for field messages on 'Broadcast'
        db.delete_table('broadcasts_broadcast_messages')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 16, 15, 55, 27, 558822)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 16, 15, 55, 27, 558740)'}),
        ...
        'broadcasts.broadcast': {
            ...
            'with_reports': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'with_sms': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
