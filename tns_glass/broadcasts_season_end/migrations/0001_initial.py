...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BroadcastsOnSeasonEnd'
        db.create_table(u'broadcasts_season_end_broadcastsonseasonend', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'broadcasts_season_end_broadcastsonseasonend_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'broadcasts_season_end_broadcastsonseasonend_modifications', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'broadcasts_season_end', ['BroadcastsOnSeasonEnd'])
    ...
    def backwards(self, orm):
        # Deleting model 'BroadcastsOnSeasonEnd'
        db.delete_table(u'broadcasts_season_end_broadcastsonseasonend')
    ...
    models = {
        ...
        u'broadcasts_season_end.broadcastonseasonendmessageslog': {
            'Meta': {'object_name': 'BroadcastOnSeasonEndMessagesLog'},
            'broadcasts_on_season_end': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['broadcasts_season_end.BroadcastsOnSeasonEnd']"}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'broadcasts_season_end_broadcastonseasonendmessageslog_creations'", 'to': u"orm['auth.User']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rapidsms_httprouter.Message']"}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'broadcasts_season_end_broadcastonseasonendmessageslog_modifications'", 'to': u"orm['auth.User']"}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'report_season': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['seasons.Season']", 'null': 'True', 'blank': 'True'}),
