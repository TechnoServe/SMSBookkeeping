...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'BroadcastOnSeasonEndMessagesLog'
        db.delete_table(u'broadcasts_season_end_broadcastonseasonendmessageslog')

        # Adding M2M table for field messages on 'BroadcastsOnSeasonEnd'
        m2m_table_name = db.shorten_name(u'broadcasts_season_end_broadcastsonseasonend_messages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('broadcastsonseasonend', models.ForeignKey(orm[u'broadcasts_season_end.broadcastsonseasonend'], null=False)),
            ('message', models.ForeignKey(orm[u'rapidsms_httprouter.message'], null=False))
        ))
        db.create_unique(m2m_table_name, ['broadcastsonseasonend_id', 'message_id'])

        # Adding M2M table for field wetmills on 'BroadcastsOnSeasonEnd'
        m2m_table_name = db.shorten_name(u'broadcasts_season_end_broadcastsonseasonend_wetmills')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('broadcastsonseasonend', models.ForeignKey(orm[u'broadcasts_season_end.broadcastsonseasonend'], null=False)),
            ('wetmill', models.ForeignKey(orm[u'wetmills.wetmill'], null=False))
        ))
        db.create_unique(m2m_table_name, ['broadcastsonseasonend_id', 'wetmill_id'])

        # Adding M2M table for field report_seasons on 'BroadcastsOnSeasonEnd'
        m2m_table_name = db.shorten_name(u'broadcasts_season_end_broadcastsonseasonend_report_seasons')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('broadcastsonseasonend', models.ForeignKey(orm[u'broadcasts_season_end.broadcastsonseasonend'], null=False)),
            ('season', models.ForeignKey(orm[u'seasons.season'], null=False))
        ))
        db.create_unique(m2m_table_name, ['broadcastsonseasonend_id', 'season_id'])


    def backwards(self, orm):
        # Adding model 'BroadcastOnSeasonEndMessagesLog'
        db.create_table(u'broadcasts_season_end_broadcastonseasonendmessageslog', (
            ('report_season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seasons.Season'], null=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('broadcasts_on_season_end', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['broadcasts_season_end.BroadcastsOnSeasonEnd'])),
            ...
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'broadcasts_season_end_broadcastonseasonendmessageslog_modifications', to=orm['auth.User'])),
            ('wetmill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wetmills.Wetmill'])),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'broadcasts_season_end_broadcastonseasonendmessageslog_creations', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'broadcasts_season_end', ['BroadcastOnSeasonEndMessagesLog'])

        # Removing M2M table for field messages on 'BroadcastsOnSeasonEnd'
        db.delete_table(db.shorten_name(u'broadcasts_season_end_broadcastsonseasonend_messages'))

        # Removing M2M table for field wetmills on 'BroadcastsOnSeasonEnd'
        db.delete_table(db.shorten_name(u'broadcasts_season_end_broadcastsonseasonend_wetmills'))

        # Removing M2M table for field report_seasons on 'BroadcastsOnSeasonEnd'
        db.delete_table(db.shorten_name(u'broadcasts_season_end_broadcastsonseasonend_report_seasons'))
    ...
    models = {
        ...
        u'broadcasts_season_end.broadcastsonseasonend': {
            'Meta': {'object_name': 'BroadcastsOnSeasonEnd'},
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'broadcasts_season_end_broadcastsonseasonend_creations'", 'to': u"orm['auth.User']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'messages': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['rapidsms_httprouter.Message']", 'null': 'True', 'blank': 'True'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'broadcasts_season_end_broadcastsonseasonend_modifications'", 'to': u"orm['auth.User']"}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'recipients': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'report_seasons': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['seasons.Season']", 'null': 'True', 'blank': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {'max_length': '480'}),
            'wetmills': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['wetmills.Wetmill']", 'null': 'True', 'blank': 'True'})
        },
    ...
    complete_apps = ['broadcasts_season_end']