...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Wetmill.sms_system'
        db.delete_column(u'wetmills_wetmill', 'sms_system')


    def backwards(self, orm):
        
        # Adding field 'Wetmill.sms_system'
        db.add_column(u'wetmills_wetmill', 'sms_system', self.gf('django.db.models.fields.CharField')(default='2012', max_length=4, null=True), keep_default=False)
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 13, 53, 19, 726257)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 13, 53, 19, 725751)'}),
