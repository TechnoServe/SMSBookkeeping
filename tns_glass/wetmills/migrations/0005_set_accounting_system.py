...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for season in orm['seasons.Season'].objects.all():
            for wetmill in orm['wetmills.Wetmill'].objects.filter(country=season.country):
                orm['wetmills.WetmillSeasonAccountingSystem'].objects.create(season=season,
                                                                             wetmill=wetmill,
                                                                             accounting_system=wetmill.sms_system)
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 12, 23, 23, 139369)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 12, 23, 23, 138825)'}),
