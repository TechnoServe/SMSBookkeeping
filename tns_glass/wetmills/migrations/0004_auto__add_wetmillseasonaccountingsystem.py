...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WetmillSeasonAccountingSystem'
        db.create_table(u'wetmills_wetmillseasonaccountingsystem', (
            ...
            ('accounting_system', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal(u'wetmills', ['WetmillSeasonAccountingSystem'])


    def backwards(self, orm):
        
        # Deleting model 'WetmillSeasonAccountingSystem'
        db.delete_table(u'wetmills_wetmillseasonaccountingsystem')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 12, 27, 14, 999379)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 12, 27, 14, 998871)'}),
        ...
        u'wetmills.wetmillseasonaccountingsystem': {
            'Meta': {'object_name': 'WetmillSeasonAccountingSystem'},
