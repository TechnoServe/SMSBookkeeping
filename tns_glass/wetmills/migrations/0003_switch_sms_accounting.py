...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        Wetmill.objects.filter(country__country_code='ET').update(sms_system='2012')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 15, 13, 21, 27, 83730)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 15, 13, 21, 27, 83196)'}),
