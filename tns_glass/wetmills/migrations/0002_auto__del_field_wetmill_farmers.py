...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Wetmill.farmers'
        db.delete_column('wetmills_wetmill', 'farmers')


    def backwards(self, orm):
        
        # Adding field 'Wetmill.farmers'
        db.add_column('wetmills_wetmill', 'farmers', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True, blank=True), keep_default=False)
