...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CashSource.name_es'
        db.add_column(u'cashsources_cashsource', 'name_es', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CashSource.name_es'
        db.delete_column(u'cashsources_cashsource', 'name_es')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 8, 27, 44, 545317)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 8, 27, 44, 544815)'}),
