...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for assumptions in orm['dashboard.Assumptions'].objects.all():
            assumptions.alert_last_cherry_price = Decimal("100")
            assumptions.alert_average_cherry_price = Decimal("100")
            assumptions.alert_working_capital_op_exp = Decimal("35")
            assumptions.alert_cash_balance = Decimal("0")
            assumptions.save()
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 7, 9, 31, 53, 100727)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 7, 9, 31, 53, 100191)'}),
