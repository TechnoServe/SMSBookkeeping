...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assumptions.alert_parchment_tabled'
        db.add_column(u'dashboard_assumptions', 'alert_parchment_tabled', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Assumptions.alert_last_cherry_price'
        db.add_column(u'dashboard_assumptions', 'alert_last_cherry_price', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Assumptions.alert_average_cherry_price'
        db.add_column(u'dashboard_assumptions', 'alert_average_cherry_price', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Assumptions.alert_working_capital_op_exp'
        db.add_column(u'dashboard_assumptions', 'alert_working_capital_op_exp', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Assumptions.alert_cash_balance'
        db.add_column(u'dashboard_assumptions', 'alert_cash_balance', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assumptions.alert_parchment_tabled'
        db.delete_column(u'dashboard_assumptions', 'alert_parchment_tabled')

        # Deleting field 'Assumptions.alert_last_cherry_price'
        db.delete_column(u'dashboard_assumptions', 'alert_last_cherry_price')

        # Deleting field 'Assumptions.alert_average_cherry_price'
        db.delete_column(u'dashboard_assumptions', 'alert_average_cherry_price')

        # Deleting field 'Assumptions.alert_working_capital_op_exp'
        db.delete_column(u'dashboard_assumptions', 'alert_working_capital_op_exp')

        # Deleting field 'Assumptions.alert_cash_balance'
        db.delete_column(u'dashboard_assumptions', 'alert_cash_balance')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 7, 8, 27, 56, 469962)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 7, 8, 27, 56, 469453)'}),
        ...
        u'dashboard.assumptions': {
            ...
            'alert_average_cherry_price': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'alert_cash_balance': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'alert_last_cherry_price': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'alert_parchment_tabled': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'alert_working_capital_op_exp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'dashboard_assumptions_creations'", 'to': u"orm['auth.User']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'dashboard_assumptions_modifications'", 'to': u"orm['auth.User']"}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        u'dashboard.nycherryprice': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'dashboard_nycherryprice_creations'", 'to': u"orm['auth.User']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'dashboard_nycherryprice_modifications'", 'to': u"orm['auth.User']"}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        u'dashboard.predictedoutput': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'dashboard_predictedoutput_creations'", 'to': u"orm['auth.User']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'dashboard_predictedoutput_modifications'", 'to': u"orm['auth.User']"}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
