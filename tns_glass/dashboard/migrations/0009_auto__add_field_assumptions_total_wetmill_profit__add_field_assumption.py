...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assumptions.total_wetmill_profit'
        db.add_column(u'dashboard_assumptions', 'total_wetmill_profit',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Assumptions.total_farmer_distribution_amount'
        db.add_column(u'dashboard_assumptions', 'total_farmer_distribution_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Assumptions.total_yearly_reinvestment_amount'
        db.add_column(u'dashboard_assumptions', 'total_yearly_reinvestment_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Assumptions.wetmill_second_price'
        db.add_column(u'dashboard_assumptions', 'wetmill_second_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assumptions.total_wetmill_profit'
        db.delete_column(u'dashboard_assumptions', 'total_wetmill_profit')

        # Deleting field 'Assumptions.total_farmer_distribution_amount'
        db.delete_column(u'dashboard_assumptions', 'total_farmer_distribution_amount')

        # Deleting field 'Assumptions.total_yearly_reinvestment_amount'
        db.delete_column(u'dashboard_assumptions', 'total_yearly_reinvestment_amount')

        # Deleting field 'Assumptions.wetmill_second_price'
        db.delete_column(u'dashboard_assumptions', 'wetmill_second_price')
    ...
    models = {
        ...
        u'dashboard.assumptions': {
            ...
            'total_farmer_distribution_amount': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '14', 'decimal_places': '2', 'blank': 'True'}),
            'total_wetmill_profit': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '14', 'decimal_places': '2', 'blank': 'True'}),
            'total_working_capital': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '14', 'decimal_places': '2', 'blank': 'True'}),
            'total_yearly_reinvestment_amount': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '14', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'wetmill_second_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
