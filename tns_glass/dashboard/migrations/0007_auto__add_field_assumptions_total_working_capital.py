...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assumptions.total_working_capital'
        db.add_column(u'dashboard_assumptions', 'total_working_capital',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assumptions.total_working_capital'
        db.delete_column(u'dashboard_assumptions', 'total_working_capital')
    ...
    models = {
        ...
        u'dashboard.assumptions': {
            ...
            'total_working_capital': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
