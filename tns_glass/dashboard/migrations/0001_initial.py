...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PredictedOutput'
        db.create_table('dashboard_predictedoutput', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='predictedoutput_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='predictedoutput_modifications', to=orm['auth.User'])),
        ...
        db.send_create_signal('dashboard', ['PredictedOutput'])

        # Adding unique constraint on 'PredictedOutput', fields ['season', 'week']
        db.create_unique('dashboard_predictedoutput', ['season_id', 'week'])

        # Adding model 'Assumptions'
        db.create_table('dashboard_assumptions', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assumptions_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assumptions_modifications', to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('cherry_parchment_ratio', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=4)),
            ('parchment_green_ratio', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=4)),
            ('green_price_differential', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=4)),
            ('parchment_value', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('season_start', self.gf('django.db.models.fields.DateField')()),
            ('season_end', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('dashboard', ['Assumptions'])

        # Adding unique constraint on 'Assumptions', fields ['season', 'wetmill']
        db.create_unique('dashboard_assumptions', ['season_id', 'wetmill_id'])

        # Adding unique constraint on 'Assumptions', fields ['season', 'csp']
        db.create_unique('dashboard_assumptions', ['season_id', 'csp_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Assumptions', fields ['season', 'csp']
        db.delete_unique('dashboard_assumptions', ['season_id', 'csp_id'])

        # Removing unique constraint on 'Assumptions', fields ['season', 'wetmill']
        db.delete_unique('dashboard_assumptions', ['season_id', 'wetmill_id'])

        # Removing unique constraint on 'PredictedOutput', fields ['season', 'week']
        db.delete_unique('dashboard_predictedoutput', ['season_id', 'week'])

        # Deleting model 'PredictedOutput'
        db.delete_table('dashboard_predictedoutput')

        # Deleting model 'Assumptions'
        db.delete_table('dashboard_assumptions')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 14, 29, 20, 623030)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 14, 29, 20, 622944)'}),
