...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Assumptions.total_working_capital'
        db.alter_column(u'dashboard_assumptions', 'total_working_capital', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Assumptions.total_working_capital'
        db.alter_column(u'dashboard_assumptions', 'total_working_capital', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
