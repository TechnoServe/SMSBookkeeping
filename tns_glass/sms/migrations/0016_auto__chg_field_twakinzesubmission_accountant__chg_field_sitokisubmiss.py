...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        try:
            # Changing field 'TwakinzeSubmission.accountant'
            db.delete_index('sms_twakinzesubmission', 'accountant_id')
            db.alter_column('sms_twakinzesubmission', 'accountant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.Accountant'], null=True))
        except Exception as e:
            import traceback
            traceback.print_exc(e)
            raise e

        # Changing field 'SitokiSubmission.accountant'
        db.alter_column('sms_sitokisubmission', 'accountant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.Accountant'], null=True))

        # Changing field 'AmafarangaSubmission.accountant'
        db.alter_column('sms_amafarangasubmission', 'accountant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.Accountant'], null=True))

        # Changing field 'IbitumbweSubmission.accountant'
        db.alter_column('sms_ibitumbwesubmission', 'accountant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.Accountant'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'TwakinzeSubmission.accountant'
        raise RuntimeError("Cannot reverse this migration. 'TwakinzeSubmission.accountant' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'SitokiSubmission.accountant'
        raise RuntimeError("Cannot reverse this migration. 'SitokiSubmission.accountant' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AmafarangaSubmission.accountant'
        raise RuntimeError("Cannot reverse this migration. 'AmafarangaSubmission.accountant' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'IbitumbweSubmission.accountant'
        raise RuntimeError("Cannot reverse this migration. 'IbitumbweSubmission.accountant' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 31, 8, 47, 29, 633860)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 31, 8, 47, 29, 633764)'}),
        ...
        'sms.amafarangasubmission': {
            ...
            'accountant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sms.Accountant']", 'null': 'True'}),
