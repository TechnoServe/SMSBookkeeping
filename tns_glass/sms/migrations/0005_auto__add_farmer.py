...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Farmer'
        db.create_table('sms_farmer', (
            ('actor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sms.Actor'], unique=True, primary_key=True)),
            ('wetmill', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='farmers', null=True, to=orm['wetmills.Wetmill'])),
        ))
        db.send_create_signal('sms', ['Farmer'])


    def backwards(self, orm):
        
        # Deleting model 'Farmer'
        db.delete_table('sms_farmer')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 11, 9, 31, 25, 963341)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 11, 9, 31, 25, 963255)'}),
