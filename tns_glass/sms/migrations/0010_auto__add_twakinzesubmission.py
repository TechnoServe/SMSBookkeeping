...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TwakinzeSubmission'
        db.create_table('sms_twakinzesubmission', (
            ...
            ('report_day', self.gf('django.db.models.fields.DateField')()),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seasons.Season'])),
        ))
        db.send_create_signal('sms', ['TwakinzeSubmission'])


    def backwards(self, orm):
        
        # Deleting model 'TwakinzeSubmission'
        db.delete_table('sms_twakinzesubmission')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 12, 13, 47, 2, 579122)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 12, 13, 47, 2, 579034)'}),
