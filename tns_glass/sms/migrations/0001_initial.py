...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Actor'
        db.create_table('sms_actor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('connection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Connection'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('language', self.gf('django.db.models.fields.CharField')(default='rw', max_length=5)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('sms', ['Actor'])

        # Adding model 'WetmillObserver'
        db.create_table('sms_wetmillobserver', (
            ('actor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sms.Actor'], unique=True, primary_key=True)),
            ('wetmill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wetmills.Wetmill'], null=True, blank=True)),
        ))
        db.send_create_signal('sms', ['WetmillObserver'])

        # Adding model 'Accountant'
        db.create_table('sms_accountant', (
            ('actor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sms.Actor'], unique=True, primary_key=True)),
            ('wetmill', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='accountants', null=True, to=orm['wetmills.Wetmill'])),
        ))
        db.send_create_signal('sms', ['Accountant'])

        # Adding model 'CSPOfficer'
        db.create_table('sms_cspofficer', (
            ('actor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sms.Actor'], unique=True, primary_key=True)),
            ('csp', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['csps.CSP'], null=True, blank=True)),
        ))
        db.send_create_signal('sms', ['CSPOfficer'])

        # Adding model 'CPO'
        db.create_table('sms_cpo', (
            ('actor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sms.Actor'], unique=True, primary_key=True)),
            ('cpo_id', self.gf('django.db.models.fields.IntegerField')()),
            ('wetmill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wetmills.Wetmill'], null=True, blank=True)),
        ))
        db.send_create_signal('sms', ['CPO'])

        # Adding model 'SMSSubmission'
        db.create_table('sms_smssubmission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('sms', ['SMSSubmission'])

        # Adding model 'StoreSubmission'
        db.create_table('sms_storesubmission', (
            ('smssubmission_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sms.SMSSubmission'], unique=True, primary_key=True)),
            ('accountant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.Accountant'])),
            ...
            ('daylot', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('gradea_moved', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('gradeb_moved', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
        ))
        db.send_create_signal('sms', ['StoreSubmission'])

        # Adding model 'ShippingSubmission'
        db.create_table('sms_shippingsubmission', (
            ('smssubmission_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sms.SMSSubmission'], unique=True, primary_key=True)),
            ('accountant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.Accountant'])),
            ('wetmill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wetmills.Wetmill'])),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seasons.Season'])),
            ('parchmenta_kg', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('parchmenta_bags', self.gf('django.db.models.fields.IntegerField')()),
            ('parchmentb_kg', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('parchmentb_bags', self.gf('django.db.models.fields.IntegerField')()),
            ('license_plate', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('sms', ['ShippingSubmission'])

        # Adding model 'ReceivedSubmission'
        db.create_table('sms_receivedsubmission', (
            ('smssubmission_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sms.SMSSubmission'], unique=True, primary_key=True)),
            ('officer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.CSPOfficer'])),
            ('license_plate', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('wetmill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wetmills.Wetmill'])),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seasons.Season'])),
            ('parchmenta_kg', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ...
            ('parchmentb_kg', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('parchmentb_bags', self.gf('django.db.models.fields.IntegerField')()),
            ('moisture_content', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('cupping_score', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
        ))
        db.send_create_signal('sms', ['ReceivedSubmission'])

        # Adding model 'CashSubmission'
        db.create_table('sms_cashsubmission', (
            ('smssubmission_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sms.SMSSubmission'], unique=True, primary_key=True)),
            ('accountant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.Accountant'])),
            ('wetmill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wetmills.Wetmill'])),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seasons.Season'])),
            ('working_capital', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('income', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('cash_advances', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('salaries', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('site_collector_wages', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('cherry_transport_wages', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('casual_wages', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('other_cash_out', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
        ))
        db.send_create_signal('sms', ['CashSubmission'])

        # Adding model 'CherrySubmission'
        db.create_table('sms_cherrysubmission', (
            ('smssubmission_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sms.SMSSubmission'], unique=True, primary_key=True)),
            ('accountant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.Accountant'])),
            ('wetmill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wetmills.Wetmill'])),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seasons.Season'])),
            ('cpo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.CPO'])),
            ('daylot', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('cash_price', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('credit_price', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('cherry', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('cash_advance', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('credit_paid_off', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('cherry_paid_cash', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('cherry_paid_credit', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
        ))
        db.send_create_signal('sms', ['CherrySubmission'])

        # Adding model 'ReturnSubmission'
        db.create_table('sms_returnsubmission', (
            ('smssubmission_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sms.SMSSubmission'], unique=True, primary_key=True)),
            ('accountant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.Accountant'])),
            ('wetmill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wetmills.Wetmill'])),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seasons.Season'])),
            ('cpo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.CPO'])),
            ('cash', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
        ))
        db.send_create_signal('sms', ['ReturnSubmission'])

        # Adding model 'SummarySubmission'
        db.create_table('sms_summarysubmission', (
            ('smssubmission_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sms.SMSSubmission'], unique=True, primary_key=True)),
            ('accountant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.Accountant'])),
            ('wetmill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wetmills.Wetmill'])),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seasons.Season'])),
            ...
            ('stored', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('sent', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('balance', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
        ))
        db.send_create_signal('sms', ['SummarySubmission'])

        # Adding model 'Broadcast'
        db.create_table('sms_broadcast', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('to_accountant', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('to_observer', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('to_cpo', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('to_csp_officer', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('csp', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['csps.CSP'])),
            ('system', self.gf('django.db.models.fields.CharField')(default='ALL', max_length=4)),
        ...
        db.send_create_signal('sms', ['Broadcast'])

        # Adding M2M table for field wetmills on 'Broadcast'
        db.create_table('sms_broadcast_wetmills', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('broadcast', models.ForeignKey(orm['sms.broadcast'], null=False)),
            ('wetmill', models.ForeignKey(orm['wetmills.wetmill'], null=False))
        ))
        db.create_unique('sms_broadcast_wetmills', ['broadcast_id', 'wetmill_id'])


    def backwards(self, orm):
        
        # Deleting model 'Actor'
        db.delete_table('sms_actor')

        # Deleting model 'WetmillObserver'
        db.delete_table('sms_wetmillobserver')

        # Deleting model 'Accountant'
        db.delete_table('sms_accountant')

        # Deleting model 'CSPOfficer'
        db.delete_table('sms_cspofficer')

        # Deleting model 'CPO'
        db.delete_table('sms_cpo')

        # Deleting model 'SMSSubmission'
        db.delete_table('sms_smssubmission')

        # Deleting model 'StoreSubmission'
        db.delete_table('sms_storesubmission')

        # Deleting model 'ShippingSubmission'
        db.delete_table('sms_shippingsubmission')

        # Deleting model 'ReceivedSubmission'
        db.delete_table('sms_receivedsubmission')

        # Deleting model 'CashSubmission'
        db.delete_table('sms_cashsubmission')

        # Deleting model 'CherrySubmission'
        db.delete_table('sms_cherrysubmission')

        # Deleting model 'ReturnSubmission'
        db.delete_table('sms_returnsubmission')

        # Deleting model 'SummarySubmission'
        db.delete_table('sms_summarysubmission')

        # Deleting model 'Broadcast'
        db.delete_table('sms_broadcast')

        # Removing M2M table for field wetmills on 'Broadcast'
        db.delete_table('sms_broadcast_wetmills')
    ...
    models = {
        ...
        'sms.broadcast': {
            ...
            'system': ('django.db.models.fields.CharField', [], {'default': "'ALL'", 'max_length': '4'}),
            'to_accountant': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'to_cpo': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'to_csp_officer': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'to_observer': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'wetmills': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['wetmills.Wetmill']", 'null': 'True', 'blank': 'True'})
        },
        'sms.cashsubmission': {
