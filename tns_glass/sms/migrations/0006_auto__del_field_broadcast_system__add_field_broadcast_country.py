...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Broadcast.system'
        db.delete_column('sms_broadcast', 'system')

        # Adding field 'Broadcast.country'
        db.add_column('sms_broadcast', 'country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locales.Country'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Broadcast.system'
        db.add_column('sms_broadcast', 'system', self.gf('django.db.models.fields.CharField')(default='ALL', max_length=4), keep_default=False)

        # Deleting field 'Broadcast.country'
        db.delete_column('sms_broadcast', 'country_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 14, 11, 55, 22, 882216)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 14, 11, 55, 22, 882132)'}),
