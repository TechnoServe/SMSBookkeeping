...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Broadcast.sender'
        db.delete_column('sms_broadcast', 'sender_id')

        # Deleting field 'Broadcast.created'
        db.delete_column('sms_broadcast', 'created')

        # Adding field 'Broadcast.is_active'
        db.add_column('sms_broadcast', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Broadcast.created_by'
        db.add_column('sms_broadcast', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='broadcast_creations', to=orm['auth.User']), keep_default=False)

        # Adding field 'Broadcast.created_on'
        db.add_column('sms_broadcast', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=0, blank=True), keep_default=False)

        # Adding field 'Broadcast.modified_by'
        db.add_column('sms_broadcast', 'modified_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='broadcast_modifications', to=orm['auth.User']), keep_default=False)

        # Adding field 'Broadcast.modified_on'
        db.add_column('sms_broadcast', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Broadcast.sender'
        raise RuntimeError("Cannot reverse this migration. 'Broadcast.sender' and its values cannot be restored.")

        # Adding field 'Broadcast.created'
        db.add_column('sms_broadcast', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=0, blank=True), keep_default=False)

        # Deleting field 'Broadcast.is_active'
        db.delete_column('sms_broadcast', 'is_active')

        # Deleting field 'Broadcast.created_by'
        db.delete_column('sms_broadcast', 'created_by_id')

        # Deleting field 'Broadcast.created_on'
        db.delete_column('sms_broadcast', 'created_on')

        # Deleting field 'Broadcast.modified_by'
        db.delete_column('sms_broadcast', 'modified_by_id')

        # Deleting field 'Broadcast.modified_on'
        db.delete_column('sms_broadcast', 'modified_on')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 14, 12, 2, 12, 519888)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 14, 12, 2, 12, 519801)'}),
        ...
        'sms.broadcast': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['locales.Country']", 'null': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'broadcast_creations'", 'to': "orm['auth.User']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'broadcast_modifications'", 'to': "orm['auth.User']"}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            ...
            'to_farmers': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
