...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SitokiSubmission'
        db.create_table('sms_sitokisubmission', (
            ...
            ('start_of_week', self.gf('django.db.models.fields.DateField')()),
            ('grade_a_stored', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('grade_b_stored', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('grade_c_stored', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('grade_a_shipped', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('grade_b_shipped', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('grade_c_shipped', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
        ))
        db.send_create_signal('sms', ['SitokiSubmission'])

        # Adding model 'AmafarangaSubmission'
        db.create_table('sms_amafarangasubmission', (
            ('smssubmission_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sms.SMSSubmission'], unique=True, primary_key=True)),
            ('accountant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.Accountant'])),
            ('wetmill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wetmills.Wetmill'])),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seasons.Season'])),
            ('start_of_week', self.gf('django.db.models.fields.DateField')()),
            ('opening_balance', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('working_capital', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('other_income', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('returned', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('advanced', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('full_time_labor', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('casual_labor', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('commission', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('transport', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('other_expenses', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
        ))
        db.send_create_signal('sms', ['AmafarangaSubmission'])

        # Adding model 'IbitumbweSubmission'
        db.create_table('sms_ibitumbwesubmission', (
            ('smssubmission_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sms.SMSSubmission'], unique=True, primary_key=True)),
            ('accountant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sms.Accountant'])),
            ('wetmill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wetmills.Wetmill'])),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seasons.Season'])),
            ('cash_advanced', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('cash_returned', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('cash_spent', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('credit_spent', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('cherry_purchased', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('credit_cleared', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
        ))
        db.send_create_signal('sms', ['IbitumbweSubmission'])


    def backwards(self, orm):
        
        # Deleting model 'SitokiSubmission'
        db.delete_table('sms_sitokisubmission')

        # Deleting model 'AmafarangaSubmission'
        db.delete_table('sms_amafarangasubmission')

        # Deleting model 'IbitumbweSubmission'
        db.delete_table('sms_ibitumbwesubmission')
    ...
    models = {
        ...
        'sms.amafarangasubmission': {
            ...
            'returned': ('django.db.models.fields.DecimalField', [], {'max_digits': '16', 'decimal_places': '2'}),
            'season': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['seasons.Season']"}),
        ...
        'sms.ibitumbwesubmission': {
            ...
            'credit_cleared': ('django.db.models.fields.DecimalField', [], {'max_digits': '16', 'decimal_places': '2'}),
