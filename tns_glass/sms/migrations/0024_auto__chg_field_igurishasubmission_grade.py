...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IgurishaSubmission.grade'
        db.alter_column(u'sms_igurishasubmission', 'grade', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'IgurishaSubmission.grade'
        db.alter_column(u'sms_igurishasubmission', 'grade', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))
    ...
    models = {
        ...
        u'sms.igurishasubmission': {
            ...
            'exchange_rate': ('django.db.models.fields.DecimalField', [], {'max_digits': '16', 'decimal_places': '2'}),
            'grade': ('django.db.models.fields.TextField', [], {}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
