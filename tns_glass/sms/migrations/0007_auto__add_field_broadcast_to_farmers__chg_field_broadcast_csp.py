...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Broadcast.to_farmers'
        db.add_column('sms_broadcast', 'to_farmers', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Broadcast.csp'
        db.alter_column('sms_broadcast', 'csp_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['csps.CSP'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'Broadcast.to_farmers'
        db.delete_column('sms_broadcast', 'to_farmers')

        # User chose to not deal with backwards NULL issues for 'Broadcast.csp'
        raise RuntimeError("Cannot reverse this migration. 'Broadcast.csp' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 14, 11, 57, 10, 194208)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 14, 11, 57, 10, 194116)'}),
