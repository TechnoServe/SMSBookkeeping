...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IgurishaSubmission.buyer'
        db.add_column(u'sms_igurishasubmission', 'buyer',
                      self.gf('django.db.models.fields.TextField')(default='[Unspecified]'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IgurishaSubmission.buyer'
        db.delete_column(u'sms_igurishasubmission', 'buyer')
