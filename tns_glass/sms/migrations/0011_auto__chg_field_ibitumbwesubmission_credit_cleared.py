...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IbitumbweSubmission.credit_cleared'
        db.alter_column('sms_ibitumbwesubmission', 'credit_cleared', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'IbitumbweSubmission.credit_cleared'
        raise RuntimeError("Cannot reverse this migration. 'IbitumbweSubmission.credit_cleared' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 17, 16, 55, 31, 99945)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 17, 16, 55, 31, 99853)'}),
