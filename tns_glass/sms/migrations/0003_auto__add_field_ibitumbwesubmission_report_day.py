...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IbitumbweSubmission.report_day'
        db.add_column('sms_ibitumbwesubmission', 'report_day', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 1, 23)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IbitumbweSubmission.report_day'
        db.delete_column('sms_ibitumbwesubmission', 'report_day')
