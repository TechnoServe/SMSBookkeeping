...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SMSSubmission.created_by'
        db.add_column('sms_smssubmission', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SMSSubmission.created_by'
        db.delete_column('sms_smssubmission', 'created_by_id')
