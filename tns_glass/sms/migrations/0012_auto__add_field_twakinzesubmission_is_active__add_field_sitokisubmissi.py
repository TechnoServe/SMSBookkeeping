...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TwakinzeSubmission.is_active'
        db.add_column('sms_twakinzesubmission', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'SitokiSubmission.is_active'
        db.add_column('sms_sitokisubmission', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'AmafarangaSubmission.is_active'
        db.add_column('sms_amafarangasubmission', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'IbitumbweSubmission.is_active'
        db.add_column('sms_ibitumbwesubmission', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TwakinzeSubmission.is_active'
        db.delete_column('sms_twakinzesubmission', 'is_active')

        # Deleting field 'SitokiSubmission.is_active'
        db.delete_column('sms_sitokisubmission', 'is_active')

        # Deleting field 'AmafarangaSubmission.is_active'
        db.delete_column('sms_amafarangasubmission', 'is_active')

        # Deleting field 'IbitumbweSubmission.is_active'
        db.delete_column('sms_ibitumbwesubmission', 'is_active')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 1, 15, 3, 8, 199016)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 1, 15, 3, 8, 198927)'}),
