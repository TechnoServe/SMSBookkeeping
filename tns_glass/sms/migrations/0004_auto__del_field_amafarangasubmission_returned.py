...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AmafarangaSubmission.returned'
        db.delete_column('sms_amafarangasubmission', 'returned')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'AmafarangaSubmission.returned'
        raise RuntimeError("Cannot reverse this migration. 'AmafarangaSubmission.returned' and its values cannot be restored.")
