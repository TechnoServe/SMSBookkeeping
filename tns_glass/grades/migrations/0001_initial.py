...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('grades_grade', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='grade_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='grade_modifications', to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['grades.Grade'])),
            ...
            ('is_not_processed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('order', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
        ))
        db.send_create_signal('grades', ['Grade'])

        # Adding unique constraint on 'Grade', fields ['parent', 'name']
        db.create_unique('grades_grade', ['parent_id', 'name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Grade', fields ['parent', 'name']
        db.delete_unique('grades_grade', ['parent_id', 'name'])
