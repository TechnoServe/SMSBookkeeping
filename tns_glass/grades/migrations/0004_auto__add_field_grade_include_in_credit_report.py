...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Grade.include_in_credit_report'
        db.add_column(u'grades_grade', 'include_in_credit_report',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Grade.include_in_credit_report'
        db.delete_column(u'grades_grade', 'include_in_credit_report')
