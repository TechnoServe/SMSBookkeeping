...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expense.include_in_credit_report'
        db.add_column(u'expenses_expense', 'include_in_credit_report',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Expense.include_in_credit_report'
        db.delete_column(u'expenses_expense', 'include_in_credit_report')
