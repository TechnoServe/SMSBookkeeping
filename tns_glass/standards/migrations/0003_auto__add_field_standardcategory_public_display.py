...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StandardCategory.public_display'
        db.add_column('standards_standardcategory', 'public_display', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StandardCategory.public_display'
        db.delete_column('standards_standardcategory', 'public_display')
