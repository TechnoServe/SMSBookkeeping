...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Standard.name_es'
        db.add_column(u'standards_standard', 'name_es', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'StandardCategory.name_es'
        db.add_column(u'standards_standardcategory', 'name_es', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Standard.name_es'
        db.delete_column(u'standards_standard', 'name_es')

        # Deleting field 'StandardCategory.name_es'
        db.delete_column(u'standards_standardcategory', 'name_es')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 8, 24, 12, 291710)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 8, 24, 12, 291220)'}),
