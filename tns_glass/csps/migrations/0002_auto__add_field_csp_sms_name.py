...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CSP.sms_name'
        db.add_column('csps_csp', 'sms_name', self.gf('django.db.models.fields.SlugField')(default='none', unique=True, max_length=16, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CSP.sms_name'
        db.delete_column('csps_csp', 'sms_name')
