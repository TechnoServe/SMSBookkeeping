...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Blurb'
        db.create_table(u'blurbs_blurb', (
        ...
        db.send_create_signal(u'blurbs', ['Blurb'])

        # Adding unique constraint on 'Blurb', fields ['form', 'slug']
        db.create_unique(u'blurbs_blurb', ['form_id', 'slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Blurb', fields ['form', 'slug']
        db.delete_unique(u'blurbs_blurb', ['form_id', 'slug'])

        # Deleting model 'Blurb'
        db.delete_table(u'blurbs_blurb')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 15, 12, 54, 12, 472932)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 15, 12, 54, 12, 472386)'}),
