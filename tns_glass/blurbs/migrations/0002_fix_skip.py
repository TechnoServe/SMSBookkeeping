...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for b in Blurb.objects.filter(message_en_us='skip'):
            b.message_en_us = b.description
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 15, 12, 54, 47, 88593)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 15, 12, 54, 47, 88050)'}),
