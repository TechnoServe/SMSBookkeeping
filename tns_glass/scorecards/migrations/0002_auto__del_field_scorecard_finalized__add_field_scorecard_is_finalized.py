...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Scorecard.finalized'
        db.delete_column('scorecards_scorecard', 'finalized')

        # Adding field 'Scorecard.is_finalized'
        db.add_column('scorecards_scorecard', 'is_finalized', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Scorecard.finalized'
        db.add_column('scorecards_scorecard', 'finalized', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Scorecard.is_finalized'
        db.delete_column('scorecards_scorecard', 'is_finalized')
