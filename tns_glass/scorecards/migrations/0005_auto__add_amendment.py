...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scorecards_amendment', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='amendments', to=orm['auth.User'])),
    ...
    models = {
        ...
        'scorecards.amendment': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'amendments'", 'to': "orm['auth.User']"})
        },
