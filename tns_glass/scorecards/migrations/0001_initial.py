...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scorecards_scorecard', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scorecard_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scorecard_modifications', to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scorecards', to=orm['seasons.Season'])),
            ('wetmill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wetmills.Wetmill'])),
            ('client_id', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('auditor', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('audit_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('finalized', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('scorecards', ['Scorecard'])

        # Adding model 'StandardEntry'
        db.create_table('scorecards_standardentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='standardentry_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='standardentry_modifications', to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('scorecard', self.gf('django.db.models.fields.related.ForeignKey')(related_name='standard_entries', to=orm['scorecards.Scorecard'])),
            ('standard', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['standards.Standard'])),
            ('value', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('scorecards', ['StandardEntry'])

        # Adding unique constraint on 'StandardEntry', fields ['scorecard', 'standard']
        db.create_unique('scorecards_standardentry', ['scorecard_id', 'standard_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'StandardEntry', fields ['scorecard', 'standard']
        db.delete_unique('scorecards_standardentry', ['scorecard_id', 'standard_id'])

        # Deleting model 'Scorecard'
        db.delete_table('scorecards_scorecard')

        # Deleting model 'StandardEntry'
        db.delete_table('scorecards_standardentry')
    ...
    models = {
        ...
        'scorecards.standardentry': {
            ...
            'standard': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['standards.Standard']"}),
