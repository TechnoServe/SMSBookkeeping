...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scorecard.rating'
        db.add_column('scorecards_scorecard', 'rating', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Scorecard.rating'
        db.delete_column('scorecards_scorecard', 'rating')
    ...
    models = {
        ...
        'scorecards.scorecard': {
            ...
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'rating': ('django.db.models.fields.IntegerField', [], {'max_length': '1'}),
