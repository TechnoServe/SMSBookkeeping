...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Amendment.user'
        db.delete_column('scorecards_amendment', 'user_id')


    def backwards(self, orm):
        
        # Adding field 'Amendment.user'
        db.add_column('scorecards_amendment', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.date(2011, 12, 7), related_name='amendments', to=orm['auth.User']), keep_default=False)
