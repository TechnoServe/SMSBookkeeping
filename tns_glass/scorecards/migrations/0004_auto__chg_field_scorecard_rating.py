...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scorecard.rating'
        db.alter_column('scorecards_scorecard', 'rating', self.gf('django.db.models.fields.IntegerField')(max_length=1, null=True))


    def backwards(self, orm):
        
        # Changing field 'Scorecard.rating'
        db.alter_column('scorecards_scorecard', 'rating', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=1))
