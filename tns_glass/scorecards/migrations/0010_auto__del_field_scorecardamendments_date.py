...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ScorecardAmendments.date'
        db.delete_column('scorecards_scorecardamendments', 'date')


    def backwards(self, orm):
        
        # Adding field 'ScorecardAmendments.date'
        db.add_column('scorecards_scorecardamendments', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 12, 13), blank=True), keep_default=False)
