...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'scorecards.amendmentstatus': {
            'Meta': {'object_name': 'AmendmentStatus'},
            'amendment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'status'", 'to': "orm['scorecards.Amendment']"}),
            'field': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'old': ('django.db.models.fields.IntegerField', [], {'null': 'True'})
        },
