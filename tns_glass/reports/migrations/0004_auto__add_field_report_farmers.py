...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.farmers'
        db.add_column('reports_report', 'farmers', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Report.farmers'
        db.delete_column('reports_report', 'farmers')
    ...
    models = {
        ...
        'reports.report': {
            ...
            'farmers': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
