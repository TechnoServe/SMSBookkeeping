...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ReportAmendments'
        db.create_table('reports_reportamendments', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reportamendments_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reportamendments_modifications', to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(related_name='amendments', to=orm['reports.Report'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('reports', ['ReportAmendments'])


    def backwards(self, orm):
        
        # Deleting model 'ReportAmendments'
        db.delete_table('reports_reportamendments')
