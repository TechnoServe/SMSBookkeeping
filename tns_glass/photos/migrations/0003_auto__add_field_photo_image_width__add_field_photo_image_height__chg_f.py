...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('photos_photo', 'image_width', self.gf('django.db.models.fields.PositiveIntegerField')(default=100), keep_default=False)

        # Adding field 'Photo.image_height'
        db.add_column('photos_photo', 'image_height', self.gf('django.db.models.fields.PositiveIntegerField')(default=100), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('photos_photo', 'image_width')

        # Deleting field 'Photo.image_height'
        db.delete_column('photos_photo', 'image_height')
