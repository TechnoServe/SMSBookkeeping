...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScorecardImport'
        db.create_table('scorecardimports_scorecardimport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scorecardimport_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scorecardimport_modifications', to=orm['auth.User'])),
        ...
        db.send_create_signal('scorecardimports', ['ScorecardImport'])


    def backwards(self, orm):
        
        # Deleting model 'ScorecardImport'
        db.delete_table('scorecardimports_scorecardimport')
    ...
    models = {
        ...
        'scorecardimports.scorecardimport': {
            'Meta': {'ordering': "('-modified_on',)", 'object_name': 'ScorecardImport'},
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'scorecardimport_creations'", 'to': "orm['auth.User']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'csv_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_log': ('django.db.models.fields.TextField', [], {}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'scorecardimport_modifications'", 'to': "orm['auth.User']"}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
    ...
    complete_apps = ['scorecardimports']
