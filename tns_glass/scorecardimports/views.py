...
class ScorecardImportCRUDL(SmartCRUDL):
    ...
    class List(SmartListView):
        ...
        def get_context_data(self, *args, **kwargs):
            context = super(ScorecardImportCRUDL.List, self).get_context_data(*args, **kwargs)
    ...
    class Import(SmartReadView):
        def pre_process(self, request, *args, **kwargs):
            ...
            return HttpResponseRedirect(reverse('scorecardimports.scorecardimport_read', args=[self.get_object().pk]))

    class Create(SmartCreateView):
        title = _("Import Season Scorecards")
        fields = ('season', 'csv_file')
        readonly = ('season',)
        success_url = "id@scorecardimports.scorecardimport_import"

        def pre_save(self, obj):
            obj = super(ScorecardImportCRUDL.Create, self).pre_save(obj)
        ...
        def get_context_data(self, *args, **kwargs):
            context = super(ScorecardImportCRUDL.Create, self).get_context_data(*args, **kwargs)
    ...
    class Action(SmartFormView):
        ...
        def form_valid(self, form):
            ...
            if clean['template']:
                ...
                return HttpResponseRedirect(reverse("scorecardimports.scorecardimport_create") + "?season=%s" % season.id)
