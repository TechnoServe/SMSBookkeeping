...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Season.sale_price_min'
        db.delete_column('seasons_season', 'sale_price_min')

        # Deleting field 'Season.cherry_ratio_min'
        db.delete_column('seasons_season', 'cherry_ratio_min')

        # Deleting field 'Season.cherry_ratio_max'
        db.delete_column('seasons_season', 'cherry_ratio_max')

        # Deleting field 'Season.total_costs_min'
        db.delete_column('seasons_season', 'total_costs_min')

        # Deleting field 'Season.total_costs_max'
        db.delete_column('seasons_season', 'total_costs_max')

        # Deleting field 'Season.farmer_payment_min'
        db.delete_column('seasons_season', 'farmer_payment_min')

        # Deleting field 'Season.sale_price_max'
        db.delete_column('seasons_season', 'sale_price_max')

        # Deleting field 'Season.farmer_payment_max'
        db.delete_column('seasons_season', 'farmer_payment_max')

        # Adding field 'Season.farmer_payment_left'
        db.add_column('seasons_season', 'farmer_payment_left', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=4), keep_default=False)

        # Adding field 'Season.farmer_payment_right'
        db.add_column('seasons_season', 'farmer_payment_right', self.gf('django.db.models.fields.DecimalField')(default=100, max_digits=16, decimal_places=4), keep_default=False)

        # Adding field 'Season.cherry_ratio_left'
        db.add_column('seasons_season', 'cherry_ratio_left', self.gf('django.db.models.fields.DecimalField')(default=12, max_digits=16, decimal_places=4), keep_default=False)

        # Adding field 'Season.cherry_ratio_right'
        db.add_column('seasons_season', 'cherry_ratio_right', self.gf('django.db.models.fields.DecimalField')(default=5, max_digits=16, decimal_places=4), keep_default=False)

        # Adding field 'Season.total_costs_left'
        db.add_column('seasons_season', 'total_costs_left', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=4), keep_default=False)

        # Adding field 'Season.total_costs_right'
        db.add_column('seasons_season', 'total_costs_right', self.gf('django.db.models.fields.DecimalField')(default=100, max_digits=16, decimal_places=4), keep_default=False)

        # Adding field 'Season.sale_price_left'
        db.add_column('seasons_season', 'sale_price_left', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=4), keep_default=False)

        # Adding field 'Season.sale_price_right'
        db.add_column('seasons_season', 'sale_price_right', self.gf('django.db.models.fields.DecimalField')(default=10, max_digits=16, decimal_places=4), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Season.sale_price_min'
        db.add_column('seasons_season', 'sale_price_min', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=4), keep_default=False)

        # Adding field 'Season.cherry_ratio_min'
        db.add_column('seasons_season', 'cherry_ratio_min', self.gf('django.db.models.fields.DecimalField')(default=12, max_digits=16, decimal_places=4), keep_default=False)

        # Adding field 'Season.cherry_ratio_max'
        db.add_column('seasons_season', 'cherry_ratio_max', self.gf('django.db.models.fields.DecimalField')(default=5, max_digits=16, decimal_places=4), keep_default=False)

        # Adding field 'Season.total_costs_min'
        db.add_column('seasons_season', 'total_costs_min', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=4), keep_default=False)

        # Adding field 'Season.total_costs_max'
        db.add_column('seasons_season', 'total_costs_max', self.gf('django.db.models.fields.DecimalField')(default=100, max_digits=16, decimal_places=4), keep_default=False)

        # Adding field 'Season.farmer_payment_min'
        db.add_column('seasons_season', 'farmer_payment_min', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=4), keep_default=False)

        # Adding field 'Season.sale_price_max'
        db.add_column('seasons_season', 'sale_price_max', self.gf('django.db.models.fields.DecimalField')(default=10, max_digits=16, decimal_places=4), keep_default=False)

        # Adding field 'Season.farmer_payment_max'
        db.add_column('seasons_season', 'farmer_payment_max', self.gf('django.db.models.fields.DecimalField')(default=100, max_digits=16, decimal_places=4), keep_default=False)

        # Deleting field 'Season.farmer_payment_left'
        db.delete_column('seasons_season', 'farmer_payment_left')

        # Deleting field 'Season.farmer_payment_right'
        db.delete_column('seasons_season', 'farmer_payment_right')

        # Deleting field 'Season.cherry_ratio_left'
        db.delete_column('seasons_season', 'cherry_ratio_left')

        # Deleting field 'Season.cherry_ratio_right'
        db.delete_column('seasons_season', 'cherry_ratio_right')

        # Deleting field 'Season.total_costs_left'
        db.delete_column('seasons_season', 'total_costs_left')

        # Deleting field 'Season.total_costs_right'
        db.delete_column('seasons_season', 'total_costs_right')

        # Deleting field 'Season.sale_price_left'
        db.delete_column('seasons_season', 'sale_price_left')

        # Deleting field 'Season.sale_price_right'
        db.delete_column('seasons_season', 'sale_price_right')
