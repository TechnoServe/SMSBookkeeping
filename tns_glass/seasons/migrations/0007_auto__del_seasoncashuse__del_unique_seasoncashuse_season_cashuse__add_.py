...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'SeasonCashUse', fields ['season', 'cashuse']
        db.delete_unique('seasons_seasoncashuse', ['season_id', 'cashuse_id'])

        # Deleting model 'SeasonCashUse'
        db.delete_table('seasons_seasoncashuse')

        # Adding model 'SeasonFarmerPayment'
        db.create_table('seasons_seasonfarmerpayment', (
            ...
            ('applies_to', self.gf('django.db.models.fields.CharField')(max_length=4)),
        ))
        db.send_create_signal('seasons', ['SeasonFarmerPayment'])

        # Adding unique constraint on 'SeasonFarmerPayment', fields ['season', 'farmer_payment']
        db.create_unique('seasons_seasonfarmerpayment', ['season_id', 'farmer_payment_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'SeasonFarmerPayment', fields ['season', 'farmer_payment']
        db.delete_unique('seasons_seasonfarmerpayment', ['season_id', 'farmer_payment_id'])

        # Adding model 'SeasonCashUse'
        db.create_table('seasons_seasoncashuse', (
            ('cashuse', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cashuses.CashUse'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('applies_to', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seasons.Season'])),
        ))
        db.send_create_signal('seasons', ['SeasonCashUse'])

        # Adding unique constraint on 'SeasonCashUse', fields ['season', 'cashuse']
        db.create_unique('seasons_seasoncashuse', ['season_id', 'cashuse_id'])

        # Deleting model 'SeasonFarmerPayment'
        db.delete_table('seasons_seasonfarmerpayment')
    ...
    models = {
        ...
        'seasons.season': {
            ...
            'cashsources': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cashsources.CashSource']", 'symmetrical': 'False'}),
            'cashuses': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cashuses.CashUse']", 'symmetrical': 'False'}),
        ...
        'seasons.seasonfarmerpayment': {
            'Meta': {'ordering': "('cashuse__order',)", 'unique_together': "(('season', 'farmer_payment'),)", 'object_name': 'SeasonFarmerPayment'},
